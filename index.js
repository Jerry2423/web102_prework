...
// set inner HTML using template literal and toLocaleString to format as currency
...
// connect the showAllGames function to the allGamesBtn
...
const unfundedGamesText = unfundedGamesCount === 1 ? 'game remains' : 'games remain';
const descriptionText = `A total of $${totalRaised.toLocaleString()} has been raised for ${GAMES_JSON.length} games. Currently, ${unfundedGamesCount} ${unfundedGamesText} unfunded. We need your help to fund these amazing games!`;
